...
@interface APSAccountCellVC () <UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate>
...
@implementation APSAccountCellVC
...
- (void) scanBarcode{
    ...
    UIViewController *vc = [storyboard instantiateViewControllerWithIdentifier:@"STORYBOARD_BARCODE"];
